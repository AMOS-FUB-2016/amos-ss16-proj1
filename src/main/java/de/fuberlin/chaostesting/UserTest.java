...
public class UserTest {
		public String newTester() {
			new DAO<>(User.class).create(new User("Tester", "a822bd7b0419225c972475b4c49f8ff4", false));
			return "Test-Anwender wurde gespeichert!";
		}
		
		public String newAdmin() {
			new DAO<>(User.class).create(new User("Admin", "95765e67d23b721d87eacb3531b63603", true));
			return "Test-Admin wurde gespeichert!";
		}
		
		public List<User> getUsers() {
			return new DAO<>(User.class).findAll();
		}
}
