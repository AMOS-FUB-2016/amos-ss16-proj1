...
Von:
<stripes:text name="test.von" />
<br />
<br />
Nach:
<stripes:text name="test.nach" />
<br />
<br />
Datum:
<dynattr:text type="date" name="test.zeitpunkt" formatType="date"
	formatPattern="YYYY-MM-dd" value="JJJJ-MM-TT" />
<br />
<br />
Uhrzeit:
<dynattr:text type="time" name="uhrzeit"
	formatPattern="HH:mm" value="SS:MM" />
<br />
<br />
Erwachsene:
<stripes:text name="test.erwachsene" value="${test.erwachsene}" />
<br />
<br />
